    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(edu.jft.prashant.services.endpoints.UtilService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = edu.jft.prashant.services.endpoints.UtilService.class.getResource(".");
