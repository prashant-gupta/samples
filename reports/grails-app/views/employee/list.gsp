...
<div id="list-employee" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="empNumber" title="${message(code: 'employee.empNumber.label', default: 'Emp Number')}"/>
        ...
        <g:each in="${employeeInstanceList}" status="i" var="employeeInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show" id="${employeeInstance.id}">${fieldValue(bean: employeeInstance, field: "empNumber")}</g:link></td>
                ...
                <td>
                    <g:jasperReport controller="employee" action="report" format="PDF" jasper="report2" id="${employeeInstance.id}">
                        <g:hiddenField name="employeeId" value="${employeeInstance.id}"/>
                    </g:jasperReport>
                </td>
            </tr>
        </g:each>
